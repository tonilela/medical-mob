...
export default function TabTwoScreen(props) {
  ...
  useEffect(() => {
    // async function getAllUserData1 (id) {
    //     let response = await getAllUserData(id)
    ...
    setChart(charts)
    setLoading(false)
    console.log('charts---use effect-',chart)
    // console.log('users----', user)
    // const {id} = _.get(props, 'route.params.user')
    // getAllUserData1(id)
  }, []);
